      ...
      <div className="relative w-[90%] max-w-4xl h-4/5 md:h-[90%] bg-background rounded-xl overflow-hidden shadow-2xl">
        <div className="flex justify-between items-center px-4 py-2 border-b border-border bg-background/90">
          ...
          <div className="flex gap-2">
            ...
            <button onClick={onClose} className="p-2 rounded-md hover:bg-white/10 transition">
  ...
  return (
    <>
      <button
        ...
        className="
          w-full inline-flex items-center justify-center gap-2 p-4 rounded-md
      ...
      >
        ...
        <p className="text-sm uppercase tracking-widest font-extrabold">View Resume</p>
      </button>
  ...
  return (
    <div className="flex flex-col justify-between h-full px-7 py-9 md:py-12">
      <div className="flex flex-col gap-4">
        <h1 className="text-2xl lg:text-3xl font-bold tracking-tight">Julienne Panes</h1>
